 ...
 * $Id: character.cpp 510 2006-02-26 21:09:40Z zak $
...
m_dead(false)
{
	...
	m_entity = I_WORLD->sceneManager()->createEntity(getUniqueName(m_name.c_str()),mesh);
...
{
	return I_WORLD->pointIsVisible(getPosition() + Vector3(0,CHAR_SIZE,0));
};
...
bool CCharacter::canWalk(const Vector3& to, Vector2& norm)
{
