/**
 * @file ireon_cm/net/cmwc/cmwc_main_state.cpp
 * cm world server connection main state
 */
...
#include "common/net/signal_codes/wscc_codes.h"
...
CCMWCMainState::CCMWCMainState(CCMWSConnection *ownerConnection):
m_ownerConnection(ownerConnection)
{
	setStateName("Main State");
