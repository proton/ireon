...
namespace OgreOde 
{
	...
	public:
		...
		static Real SqrDistance(const Vector3& rkPoint,const Vector3& origin,const Vector3& direction);
		static void GaussPointsFit(int iQuantity,const Vector3* akPoint,Vector3 &rkCenter,Vector3 akAxis[3],Real afExtent[3]);
