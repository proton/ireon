 ...
 * $Id: ws_app.cpp 433 2005-12-20 20:19:15Z zak $
...
void CWorldApp::init()
{
	...
	float r = CWorld::instance()->heightAt(-47.314926,-298.173340);
...
void CWorldApp::initLogSystem()
{
	...
	// FIXME !!! what is 0x08 and 0x10?
	CLog::instance()->regListener(new CFileLogListener("../logs/log_walk.txt",0x08));
	CLog::instance()->regListener(new CFileLogListener("../logs/log_visible.txt",0x10));
