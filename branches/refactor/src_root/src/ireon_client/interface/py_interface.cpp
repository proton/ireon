 ...
 * $Id: py_interface.cpp 433 2005-12-20 20:19:15Z zak $
...
*/	
	...
	class_<CScrollBar, bases<CWindow> >
		("ScrollBar", no_init )
		.def("setScrollPosition",&CScrollBar::setScrollPosition)
	...
	.add_property("firstPerson",&CInterface::isFirstPerson, &CInterface::setFirstPerson )
	...
	def("get",&CInterface::instance,return_value_policy<reference_existing_object>());
};
