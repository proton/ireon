 ...
 * $Id: py_world.cpp 433 2005-12-20 20:19:15Z zak $
...
BOOST_PYTHON_MODULE(World)
{
	...
	class_< CWorld >
		("CWorld",no_init)
		.add_property("ownChar",&CWorld::getOwnChar)
		.def("translateTo2d",&CWorld::translateTo2d)
		.def("pointIsVisible",&CWorld::pointIsVisible);

	def("get",&CWorld::instance,return_value_policy<reference_existing_object>());
}
