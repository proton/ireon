 ...
 * $Id: py_events.cpp 433 2005-12-20 20:19:15Z zak $
...
bool (CEventManager::*ex)(CEventManager::EventID, EventArg*) = &CEventManager::execute;
...
BOOST_PYTHON_MODULE(Event)
{
	...
	enum_< CEventManager::EventID >
		("EventID")
		.value("APP_CHANGES_STATE",CEventManager::ON_APP_CHANGES_STATE)
		.value("CHAR_LIST_CHANGED",CEventManager::ON_CHAR_LIST_CHANGED)
		.value("ROOT_MENU_UPDATED",CEventManager::ON_ROOT_MENU_UPDATED)
		.value("CHAR_CREATED",CEventManager::ON_CHAR_CREATED)
		.value("CHAR_REMOVED",CEventManager::ON_CHAR_REMOVED)
		.value("LOGIN_FAILED",CEventManager::ON_LOGIN_FAILED)
		.value("CONNECT_FAILED",CEventManager::ON_CONN_FAILED)
		.value("CHAT",CEventManager::ON_CHAT)
		.value("CHAR_TO_WORLD",CEventManager::ON_CHAR_TO_WORLD)
		.value("CHAR_FROM_WORLD",CEventManager::ON_CHAR_FROM_WORLD)
		.value("CHAR_UPDATE",CEventManager::ON_CHAR_UPDATE)
		.value("CHAR_INFO_UPDATE",CEventManager::ON_CHAR_INFO_UPDATE);
