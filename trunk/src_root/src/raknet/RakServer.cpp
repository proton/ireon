...
#ifndef _RAKNET_IREON_CUSTOMIZATION
	if ( packet )
	{
...
{
	RemoteSystemStruct * remoteSystem = GetRemoteSystemFromPlayerID( playerChangedId, false );
...
{
	return RakPeer::GetRemoteSystemFromPlayerID( playerId, false ) != 0;
}
