/* Copyright (C) 2005 ireon.org developers council
  * $Id: window.cpp 787 2006-10-29 15:03:48Z mip $
...
// {
// 	m_window->setWidth(CEGUI::UDim(xy.x,xy.y));
// };
// 
// void CWindow::setUHeight(const Vector2& xy)
// {
// 	m_window->setHeight(CEGUI::UDim(xy.x,xy.y));
// };
// 
// Vector2 CWindow::getUWidth()
// {
// 	CEGUI::UDim udim = m_window->getWidth();
// 	return Vector2(udim.d_scale,udim.d_offset);
// };
// 
// Vector2 CWindow::getUHeight()
// {
// 	CEGUI::UDim udim = m_window->getHeight();
// 	return Vector2(udim.d_scale,udim.d_offset);
// };
// 
// 
...
// };
// 
// //UVector2 CWindow::getPosition()
// //{
// //	//CEGUI::Point p = m_window->getPosition();
// //	//return Vector2(p.d_x,p.d_y);
//	//CEGUI::UVector2 p = m_window->getPosition();
// //	return p;
//
// //};
// //void CWindow::setPosition(const UVector2& p)
// //{
...
// //};
// //
// //void CWindow::setSize(const UVector2& p)
// //{
// //	m_window->setSize(p);
// //};
// 
